                    ...
                    <div class="profile-head">
                        ...
                        <div class="profile-info d-flex">
                            ...
                            <div class="profile-details d-flex">
                                ...
                                <div class="dropdown mt-auto mb-auto dropdown"><button type="button" id="react-aria129466986-13" aria-expanded="true" data-toggle="dropdown" class="btn btn-primary light sharp i-false dropdown-toggle btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg></button></div>
                            </div>
                        </div>
                    </div>
                </div>
