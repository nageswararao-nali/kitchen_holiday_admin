...
function Home() {
  ...
  return (
        <div className='container dashboard'>
          ...
          <div class="card-title h5 text-left mt-4 mb-3">Normal Orders</div>          
          <div className='row'>
            <div className="col-xxl-4 col-md-6">
              <div className="card info-card widget-stat bg-danger">
                <div className="card-body p-4">
          ...
          <div class="card-title h5 text-left mt-4 mb-3">Subscription Orders</div>          
          <div className='row'>
            <div className="col-xxl-4 col-md-6">
              <div className="card info-card widget-stat bg-danger">
                <div className="card-body p-4">
          ...
          <div className='row'>
            ...
            <div className="col-xxl-4 col-md-6">
              <div className="card info-card sales-card widget-stat bg-secondary">
                <div className="card-body p-4">
                  <div className='media ai-icon'>
                    <span class="me-3 bgl-warning text-warning"><img src='assets/img/dal.png' width={36} /></span>                    
                    <div class="media-body">
